...
- **THEN** visual validation does NOT produce an off-screen warning (40px are visible)
...
- **THEN** Zod schema validation rejects it (positiveNumberSchema) before visual validation runs
